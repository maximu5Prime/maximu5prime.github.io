...
Verwendung:
  python fap-crop.py INPUT.png AUSGABE_PREFIX [--n-tasks 2] [--thresh 245] [--min-gap 30] [--pad 30]

Beispiele:
  python fap-crop.py fap-aufgaben/2025_T2_AI_p7.png fap-aufgaben/2025_T2_AI_2 --n-tasks 2
  python fap-crop.py fap-aufgaben/2024_T2_AI_page.png fap-aufgaben/2024_T2_AI --n-tasks 3
...
def main():
    ...
    parser.add_argument("prefix", help="Ausgabe-Prefix (z. B. fap-aufgaben/2025_T2_AI_2)")
