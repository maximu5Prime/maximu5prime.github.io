/* topics.js — Thementaxonomie Mathematik v1.0
...
window.MATHE_TOPICS = {
  ...
  /* Leaf-Node-Schema:
     id, label, subtitle, levels: string[],
     status: "available" | "coming-soon",
     exercise: { url, chapter: string|null, isFap: bool, filter: {typen, fach}|null } | null,
     topics: string[]   ← Tooltip-Inhalt */
  tree: {
    id: "root", label: "Mathematik", children: [

      { id: "funktionen", label: "Funktionen", children: [
        { id: "ganzrationale", label: "Ganzrationale Funktionen", children: [
        ...
        ]}  /* end ganzrationale.children */
      ]}  /* end funktionen.children */

    , /* second top-level branch */

      { id: "geometrie", label: "Analytische Geometrie", children: [

        { id: "vektoren", label: "Vektoren", children: [
          {
            id: "vektoren-lgs",
            label: "Vektoren & LGS",
        ...
        { id: "geraden-ebenen", label: "Geraden & Ebenen", children: [
          {
            id: "geraden",
      ...
      ]}  /* end geometrie.children */

    ]  /* end root.children */
  },  /* end tree */

  /* Geführte Pfade: geordnete Sequenz von Leaf-Node-IDs.
     Nur available-Nodes; coming-soon-Nodes werden weggelassen. */
  paths: {
